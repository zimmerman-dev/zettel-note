 ...
 ⌚12:06 pm  📆 Sat Sep 13
 🔗 **Related Concepts**: #note #cpp  [[Fundamental Data Types]] , [[Fixed-Width Integers]]
___
## 📝 Note: Char
...
|    Octal Num    | `'\(number)'`  |   Translates into char represented by octal    |
|     Hex num     | `'\x(number)'` | Translates into char represented by hex number |
___
